...
class AbsEnc : public rclcpp::Node
{
  public:
    ...
    : Node("absenc_node")
    {
      ...
      */
      ...
      arm_controller_publisher = this->create_publisher<arm_controller::msg::ArmMotorValues>("arm_values",10);
    }
   ...
   void absEncPollingCallback()
  {
    ...
    void ikValuesCallback(const sensor_msgs::msg::JointState::SharedPtr msg) {
      ...
      auto arm_msg_2 = arm_controller::msg::ArmMotorValues();
    ...
    rclcpp::Publisher<arm_controller::msg::ArmMotorValues>::SharedPtr arm_controller_publisher;
