...
{
public:
    static ABSENC_Error_t OpenPort(const char* path, uint16_t baud_rate, int& socket_fd);
    static ABSENC_Error_t PollSlave(int slave_number, ABSENC_Meas_t* measurement_data, int socket_fd);
    static ABSENC_Error_t ClosePort(int socket_fd);
};
